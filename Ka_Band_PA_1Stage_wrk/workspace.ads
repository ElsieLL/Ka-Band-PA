<ADSWorkspace Revision="9" Version="100">
    <Workspace Name="">
        ...
        <Preferences Name="Ka_Band_PA_1Stage_lib_lay.prf" />
        <Log Name="netlist.log" />
        <Preferences Name="ads_datacmps_lay.prf" />
        <Library Name="Ka_Band_PA_1Stage_lib">
            <Cell Name="Ka_Band_PA_1Stage_lib:zl_Doherty_Transmitter_3CS_noRNW_Cal_calibre" />
        </Library>
        <Cell Name="Ka_Band_PA_1Stage_lib:3CS_Cal_Sweep_Pin" />
        <Cell Name="Ka_Band_PA_1Stage_lib:3CS_Cal_Symbol" />
        <Cell Name="Ka_Band_PA_1Stage_lib:scs_files" />
        <Cell Name="Ka_Band_PA_1Stage_lib:zl_Doherty_Transmitter_3CS_noRNW_Cal_calibre" />
    </Workspace>
</ADSWorkspace>
